...
- [下载python源码: filled_step.py](https://matplotlib.org/_downloads/filled_step.py)
- [下载Jupyter notebook: filled_step.ipynb](https://matplotlib.org/_downloads/filled_step.ipynb)
