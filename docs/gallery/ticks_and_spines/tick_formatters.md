...
- [下载python源码: tick-formatters.py](https://matplotlib.org/_downloads/tick-formatters.py)
- [下载Jupyter notebook: tick-formatters.ipynb](https://matplotlib.org/_downloads/tick-formatters.ipynb)