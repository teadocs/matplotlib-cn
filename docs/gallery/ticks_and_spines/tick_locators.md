...
![刻度定位器示例](/static/images/gallery/sphx_glr_tick-locators_001.png)
...
- [下载python源码: tick-locators.py](https://matplotlib.org/_downloads/tick-locators.py)
- [下载Jupyter notebook: tick-locators.ipynb](https://matplotlib.org/_downloads/tick-locators.ipynb)