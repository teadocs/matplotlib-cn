...
- [下载python源码: triinterp_demo.py](https://matplotlib.org/_downloads/triinterp_demo.py)
- [下载Jupyter notebook: triinterp_demo.ipynb](https://matplotlib.org/_downloads/triinterp_demo.ipynb)