...
而不是创建Triangulation对象，可以直接将x，y和三角形数组传递给triplot。 如果要多次使用相同的三角测量来保存重复计算，最好使用Triangulation对象。
...
- [下载python源码: triplot_demo.py](https://matplotlib.org/_downloads/triplot_demo.py)
- [下载Jupyter notebook: triplot_demo.ipynb](https://matplotlib.org/_downloads/triplot_demo.ipynb)