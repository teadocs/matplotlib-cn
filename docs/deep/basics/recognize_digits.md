...
- $Label$是图片的真实标签：$Label=\left ( l_0, l_1, \dots, l_9 \right )$也是10维，但只有一维为1，其他都为0。例如某张图片上的数字为2，则它的标签为$(0,0,1,0, \dots, 0)$
...
演示将使用最新的 [Fluid API](http://paddlepaddle.org/documentation/docs/zh/1.2/api_cn/index_cn.html?from=matplotlib-cn)。Fluid API是最新的 PaddlePaddle API。它在不牺牲性能的情况下简化了模型配置。
...
![png](https://www.paddlepaddle.org.cn/documentation/docs/zh/_images/train_and_test.png)
