<template>
  <div class="ahome-nav">
    <div class="nav-bar">
      ...
      >
      <a
        class="btn-home-nav donation"
        :class="{ active: navId === 4 }"
        @click="navId = 4"
        >捐赠网站</a
      >
      <a
    ...
    <div class="block" :class="{ show: navId === 1 }">
      ...
      <div class="qr-item mpqr-item">
        <img
          :src="staticDomain + 'qrcode/mp_mydataset.png/qrcode'"
          alt="DATA中文公众号二维码"
        />
      </div>
    </div>
    ...
    <div class="block" :class="{ show: navId === 2 }">
      <div class>
        <p>
          欢迎加入
          <b>{{ name }} 中文社区</b>
          群聊，群内有BAT公司大牛、常春藤校友、中国顶尖高校的各类学霸，以及众多大佬！
        </p>
      </div>
      <div class="qr-item">
        <img
        ...
        />
        <span class="text"
          >站长微信（可拉微信群，备注：{{ name | lowercase }}）</span
        >
      </div>
      <div class="qr-item">
        <img
          :src="
            staticDomain + 'qrcode/qq_group_' + lowercase(name) + '.jpg@qrcode'
          "
    ...
    <div class="block" :class="{ show: navId === 3 }">
      <p>
        ...
        <a
          :href="
            'https://github.com/teadocs/' +
            lowercase(name) +
            '-cn/graphs/contributors'
          "
          target="_blank"
          >这些小伙伴</a
        >
    ...
    <div class="block" :class="{ show: navId === 4 }">
      <p>
        ...
        <b>免费</b>且 <b>无广告</b>的内容！
      </p>
      <p>
        2、维护公益项目不易，你们的支持是我
        <b>坚持翻译</b>，不断优化 <b>网站内容</b> 和 <b>阅读体验</b> 的动力！
      </p>
      ...
      <div class="qr-item">
        <img
          ...
          alt="微信付款码"
        />
        <span class="text"> <b>微信</b> 捐赠 </span>
      </div>
      <div class="qr-item">
        <img
          ...
          alt="支付宝付款码"
        />
        <span class="text"> <b>支付宝</b> 捐赠 </span>
      </div>
    </div>
